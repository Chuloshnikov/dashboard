                ...
                <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg h-44 
                    ...
                    <div className="flex justify-between items-center">
                        <div>
                            ...
                            <p className="text-2xl">78,574.32</p>
                        </div>
                    </div>
                        <div className="mt-6">
                            <Button color="white" brColor="gray" text="Download" borderRadius="10px" size="mb"/>
                        </div>
                </div>
                ...
                >
                    ...
                    <div className="flex gap-10 flex-wrap justify-center">
                                <div className="border-r-1 border-color m-4 pr-10">
                                    <div>
                                        <p>
                                            <span className="text-3xl">$105,374</span>
                                    ...
                                    <div className="mt-8">
                                        <p>
                                            <span className="text-3xl">$50,272</span>
                                        </p>
                                        <p className="text-gray-500 mt-1">
                                            Expense
                                        </p>
                                    ...
                                    <div className="mt-5">
                                        <SparkLine currentColor="blue" id="line-sparkline" type="Line" height="80px" width="250px"/>
                                    </div>
                                </div>
                    </div>
                </div>
